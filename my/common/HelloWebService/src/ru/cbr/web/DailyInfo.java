 ...
 * 
 */
@WebServiceClient(name = "DailyInfo", targetNamespace = "http://web.cbr.ru/", wsdlLocation = "file:/C:/ws.git/my/common/HelloWebService/DailyInfo.asmx.xml")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/ws.git/my/common/HelloWebService/DailyInfo.asmx.xml");

 ...
 * 
 */
@WebServiceClient(name = "HelloWebServiceImplService", targetNamespace = "http://ws.javarush.ru/", wsdlLocation = "http://localhost:1986/svc32/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWEBSERVICEIMPLSERVICE_QNAME = new QName("http://ws.javarush.ru/", "HelloWebServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:1986/svc32/hello?wsdl");
    ...
    public HelloWebService getHelloWebServiceImplPort() {
        return super.getPort(new QName("http://ws.javarush.ru/", "HelloWebServiceImplPort"), HelloWebService.class);
    }
    ...
    public HelloWebService getHelloWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.javarush.ru/", "HelloWebServiceImplPort"), HelloWebService.class, features);
    }
